...
%>
 ...
 <jsp:useBean id="adminNavbarBean" class="com.asule.usebean.admin.AdminNavbarBean"/>
 <jsp:useBean id="sidebar" class="com.asule.usebean.admin.SidebarBean"/>
  <jsp:useBean id="contentAdminHtmlRender" class="com.asule.usebean.admin.AdminContentBean" scope="request"/>
