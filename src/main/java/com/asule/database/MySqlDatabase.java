...
public class MySqlDatabase implements Serializable {
    ...
    private void init() throws SQLException, NamingException {
        ...
        DataSource dataSource = (DataSource) ctx.lookup("java:jboss/datasources/FitnessTracking");
    ...
    private void updateSchema() {
        ...
        try {
            ...
            entities.add(Member.class);
            entities.add(MembershipManagement.class);
            entities.add(BookMembership.class);
